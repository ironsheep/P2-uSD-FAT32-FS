...
- **Regression Tested**: 589 automated tests across 28 test suites, certified on two cluster geometries
...
| **[Regression Testing](src/regression-tests/README.md)** | Test infrastructure, 589 tests across 28 suites (as of v1.8.0) |
...
│   └── regression-tests/          # Regression test suite (589 tests as of v1.8.0)
