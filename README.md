...
| **[Case Study: The Card That Would Not Start](DOCs/SD-CARD-WEDGE-CASE-STUDY.md)** | Full root-cause study of cards wedged by boot-time traffic on shared pins — evidence, the theories that were wrong, and the one-command fix |
| **[Case Study: What a Socket Costs](DOCs/SD-SOCKET-TIMING-CASE-STUDY.md)** | How two microSD sockets on one board were measured against each other — the read and write phase maps that came out of it, and the driver defaults they changed |
