...
- **Regression Tested**: 464 automated tests across 25 test suites
...
| **[Regression Testing](src/regression-tests/README.md)** | Test infrastructure, 464 tests across 25 suites |
...
│
│   ├── regression-tests/          # Regression test suite (464 tests)
