...
- **Regression Tested**: 390+ automated tests across 20 test suites
...
| **[Regression Testing](regression-tests/README.md)** | Test infrastructure, 390+ tests across 20 suites |
...
│
├── regression-tests/           # Regression test suite (390+ tests)
