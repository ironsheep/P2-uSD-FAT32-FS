...
Automated hardware-verified test suite for the P2 SD Card Driver. All 26 test suites (471 tests) execute on real Propeller 2 hardware with a physical SD card.
