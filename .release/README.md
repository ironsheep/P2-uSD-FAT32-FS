...
└── src/                                Driver and application source
    ...
    └── regression-tests/                  Regression test suite
        ...
        ├── SD_RT_*_tests.spin2               28 test suites (589 tests)
...
The regression test suite (589 tests across 28 test files) is included in `src/regression-tests/`. Each test compiles with pnut-ts and runs on P2 hardware, producing pass/fail results via debug output.
