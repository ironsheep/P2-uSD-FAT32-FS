...
│   ├── Research/                          Findings that outlive this driver
...
| [Case Study: The Card That Would Not Start](DOCs/Research/SD-CARD-WEDGE-CASE-STUDY.md) | Root-cause study of cards wedged by boot-time traffic on shared pins, and the one-command fix |
| [Case Study: What a Socket Costs](DOCs/Research/SD-SOCKET-TIMING-CASE-STUDY.md) | Measuring two microSD sockets against each other: the read and write phase maps, and the defaults they set |
